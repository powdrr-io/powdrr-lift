...
| --- | --- | --- |
| Capability effects and ownership | `process/liveness.py` effect registry, `StepControlContract`, `SkillEffectSummary` | effect/ownership paths in definition-analysis tests |
