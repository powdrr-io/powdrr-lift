...
_EFFECTS: dict[tuple[str, str], CapabilityEffect] = {
    ...
    ("basedpyright-structure", "inspect_structure"): CapabilityEffect(
        "inspect_structure",
        "conditional",
        "idempotent",
        frozenset({"files"}),
        frozenset(),
        frozenset({"context"}),
        success_postconditions=("code_structure_observed",),
    ),
    ("basedpyright-symbol", "resolve_symbol"): CapabilityEffect(
        "resolve_symbol",
        "conditional",
        "idempotent",
        frozenset({"files"}),
        frozenset(),
        frozenset({"context"}),
        success_postconditions=("code_symbol_observed",),
    ),
