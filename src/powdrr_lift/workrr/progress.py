"""Progress accounting shared by agent proposal loops."""
...
class WorkflowExecutionController:
    """Track repeated actions and failures for an agent proposal loop."""
    ...
    def record_failure(self, action_signature: str) -> ProgressDecision:
        """Record a failed action and apply the repeated-failure threshold."""
